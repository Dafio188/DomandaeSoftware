...
- Name: Mobile Navbar >> menu mobile si chiude cliccando sul backdrop
...
Locator: locator('.mobile-menu-overlay.active')
Expected: not visible
Received: visible
Call log:
  - expect.not.toBeVisible with timeout 5000ms
  - waiting for locator('.mobile-menu-overlay.active')
    9 × locator resolved to <div class="mobile-menu-overlay active">…</div>
      - unexpected value "visible"

    at D:\sito\frontend\tests\navbar.spec.js:161:34
```
