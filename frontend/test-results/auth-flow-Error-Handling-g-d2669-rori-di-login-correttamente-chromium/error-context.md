...
- Name: Error Handling >> gestisce errori di login correttamente
- Location: D:\sito\frontend\tests\auth-flow.spec.js:225:3
...
Call log:
  - waiting for locator('[name="username"]')
    ...
    at D:\sito\frontend\tests\auth-flow.spec.js:238:16
```
