...
- Name: Role-based Access >> fornitore può accedere alle sue pagine
- Location: D:\sito\frontend\tests\auth-flow.spec.js:133:3
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\sito\frontend\tests\auth-flow.spec.js:143:24
```
