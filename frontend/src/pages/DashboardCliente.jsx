      ...
      <div className="row justify-content-center">
        <div className="col-12">
          <div className="text-center mb-5 pt-4">
            <div className="d-inline-flex align-items-center bg-primary bg-gradient rounded-pill px-4 py-2 mb-3">
              <FaRocket className="text-white me-2" />
              <span className="text-white fw-bold">Dashboard Cliente</span>
            </div>
            <h1 className="fw-bold text-dark mb-2">Benvenuto, <span className="text-primary">{user?.username}</span>!</h1>
            <p className="lead text-muted">Trasforma la tua idea in realtà. Crea richieste dettagliate e trova il partner perfetto per il tuo progetto software.</p>
          </div>
