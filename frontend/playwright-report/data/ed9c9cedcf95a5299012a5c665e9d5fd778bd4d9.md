...
- Name: Navbar con utente autenticato >> mostra menu utente per utenti autenticati
...
Locator: locator('text=testuser')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=testuser')

    at D:\sito\frontend\tests\navbar.spec.js:182:49
```
...
- navigation:
  ...
  - link "Registrati":
    ...
    - img
    - text: Registrati
- img "Domanda & Software - Immagine 5"
